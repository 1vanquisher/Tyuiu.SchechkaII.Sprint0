...
using Tyuiu.SchechkaII.Sprint0.Task7.V0.Lib;
namespace Tyuiu.SchechkaII.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт 0 | Выполнил: Щечка И.И. | ИИПб 25-1 ";
            ...
            Console.WriteLine("* Выполнил: Щечка Иван Иванович | ИИПб 25-1                            *");
            Console.WriteLine("************************************************************************");
            ...
            {
                Console.WriteLine("Ошибка! Разное кол-во элементов");
            }
            Console.ReadKey();
